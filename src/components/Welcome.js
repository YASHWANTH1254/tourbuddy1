...
const Homepage = () => {
  ...
  <Carousel autoPlay infiniteLoop showArrows={false} showThumbs={false} showStatus={false}>
    <div>
      <img src="https://cdn.pixabay.com/photo/2016/09/02/12/56/munnar-1639120_1280.jpg" alt="img1" />
    ...
    <div>
      <img src="https://cdn.pixabay.com/photo/2019/08/19/16/23/hills-4416877_1280.jpg" alt="img2" />
      <div className="carousel-content">
        <h1>Welcome To TourBuddy</h1>
        <p>Explore India with Just One Click!</p>
        <Link to='/states'>
    ...
    <div>
      <img src="https://cdn.pixabay.com/photo/2020/02/02/17/24/travel-4813658_1280.jpg" alt="img3" />
      <div className="carousel-content">
        <h1>Welcome To TourBuddy</h1>
        <p>Explore India with Just One Click!</p>
        <Link to='/states'>
